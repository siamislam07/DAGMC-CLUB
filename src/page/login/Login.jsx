...
const Login = () => {
    ...
    return (
        <Center>
            ...
            <div className="flex items-center mt-10 justify-center min-h-[800px] bg-slate-50 dark:bg-transparent  ">
                ...
                <div className="flex bg-gray-100 rounded-2xl shadow-lg dark:bg-transparent dark:shadow-2xl">
                    ...
                    <div className="sm:w-1/2 px-16 mb-5">
                        ...
                        <p className="text-sm mt-4 mb-8">By creating an account or signing in, you understand and agree to Indeed's Terms. You also acknowledge our Cookie and Privacy policies.</p>
                        ...
                        <div>
                            <p className="border-t py-4 border-gray-400">Don't have an Account?<Link to='/signUp'><span className="underline text-slate-600 ">Register</span></Link></p>
                        </div>
                    </div>
