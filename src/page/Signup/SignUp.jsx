...
const SignUp = () => {
    ...
    return (
        <Center className="">
            <div className="flex  mx-auto items-center mt-10 justify-center min-h-[700px] bg-slate-50 dark:bg-transparent  ">
                ...
                <div className="flex flex-row-reverse gap-4 bg-gray-100 rounded-2xl shadow-lg dark:bg-transparent dark:shadow-2xl">
                    ...
                    <div className="sm:w-1/2 sm:px-16 md:px-16 lg:px-32  mb-5">
                        ...
                        <div>
                            <p className="border-t py-4 w-72 border-gray-400">Already have an Account?<Link to='/login'><span className="underline text-slate-600 ">Login</span></Link></p>
                        </div>
                    </div>
